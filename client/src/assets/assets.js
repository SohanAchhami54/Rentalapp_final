...
export const ownerMenuLinks = [
    ...
    { name: "Add car", path: "/owner/addcar", icon: addIcon, coloredIcon: addIconColored },
    { name: "Manage Cars", path: "/owner/managecar", icon: carIcon, coloredIcon: carIconColored },
    { name: "Manage Bookings", path: "/owner/managebook", icon: listIcon, coloredIcon: listIconColored },
]
